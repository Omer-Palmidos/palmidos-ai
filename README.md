...
Tegridy Farms project — GitHub + Vercel + Neon. Pipeline specs live in docs/pipeline/ in this repo. Host-only (orchestration host): company/projects/palmidos-ai/artifacts/project.json and .database-url.
